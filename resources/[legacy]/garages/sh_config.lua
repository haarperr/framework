Config = {
	...
	Garages = {
		...
		["Freeway Station Civ"] = {
			...
			Limit = 1,
			Type = "Car",
			Faction = { "lspd", "detective", "sasp", "bcso" },
		},
		["MRPD Station Civ"] = {
		...
		["Sandy Civ"] = {
			...
			Limit = 1,
			Type = "Car",
			Faction = { "lspd", "detective", "sasp", "bcso", "paramedic", "firefighter", "lsfd-staff", "lsms", "lsms-staff" },
		},
		["Paleto Station Civ"] = {
		...
		["MRPD"] = {
			...
			Limit = -1,
			Type = "Emergency",
			Faction = { "dps", "lspd", "detective", "sasp", "bcso" },
		},
		["Sandy PD"] = {
			Id = 23,
		...
		["Pillbox"] = {
			...
			Limit = -1,
			Type = "Emergency",
			Faction = { "paramedic", "firefighter", "lsfd-staff", "lsms", "lsms-staff" },
		},
		["Capital Firestation"] = {
			Id = 24,
		...
		["Marshall Court Parking"] = {
			Id = 10613,
			InCoords = vector4(-592.8298950195312, -217.87002563476565, 36.86100769042969, 151.4343719482422),
			OutCoords = vector4(-593.2091064453125, -223.61724853515625, 36.55219268798828, 208.64598083496097),
			Limit = -1,
			Type = "Emergency",
			Faction = { "sams", "lsda", "opr" },
		},
		["Marshall Parking"] = {
			Id = 10613,
		...
		["DOJ Offices"] = {
			...
			Limit = 4,
			Type = "Car",
			Faction = { "judge", "justice", "sams", "opr" },
		},
	},
}
