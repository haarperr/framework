Config = {
	...
	Dealers = {
		...
		},
		{
			Group = "sod",
			Faction = "pd",
			Name = "SOD Shop La Mesa",
			License = "drivers",
			Kiosk = vector3(864.0086, -1339.216, 26.00093),
			Garage = 23,
			VehicleDisplay = vector4(860.9909, -1342.559, 25.56179, 91.07265),
			VehicleSpawn = vector4(860.9909, -1342.559, 25.56179, 91.07265),
			Vehicles = {
				"umkbuffalo",
				"umkalamo",
			},
