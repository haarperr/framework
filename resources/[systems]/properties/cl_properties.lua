...
Citizen.CreateThread(function()
	while true do
		...
		local grid = exports.grids:GetGrid(GetEntityCoords(PlayerPedId()), Config.GridSize)
...
function Cache(property)
	local grid = exports.grids:GetGrid(vector3(property.x, property.y, property.z), Config.GridSize)
...
RegisterCommand("property:available", function()
	...
	for id, property in pairs(Properties) do
		if property.character_id == nil and not property.Secret then
			local blip = AddBlipForCoord(property.x, property.y, property.z)
