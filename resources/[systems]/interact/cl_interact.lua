...
--[[ Commands ]]--
RegisterKeyMapping("+nsrp_interact", "Interact", "MOUSE_BUTTON", "MOUSE_MIDDLE")
RegisterCommand("+nsrp_interact", function(source, args, command)
	Interaction:SelectOption()
end, true)

RegisterKeyMapping("+nsrp_interactup", "Interact - Previous", "MOUSE_WHEEL", "IOM_WHEEL_UP")
RegisterCommand("+nsrp_interactup", function(source, args, command)
	Interaction:NextOption(-1)
end, true)

RegisterKeyMapping("+nsrp_interactdown", "Interact - Next", "MOUSE_WHEEL", "IOM_WHEEL_DOWN")
RegisterCommand("+nsrp_interactdown", function(source, args, command)
	Interaction:NextOption(1)
end, true)
