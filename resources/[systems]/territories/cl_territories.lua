...
AddEventHandler("territories:clientStart", function()
	for _, location in ipairs(Config.Labs.Locations) do
		...
		exports.oldinstances:AddInstance(GetCurrentResourceName(), location.Coords, location.Instance, false, {
			condition = function()
				return ControlZone == location.Zone or exports.user:IsOwner()
				-- return true
			end
		})
	end
