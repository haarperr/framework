...
AddEventHandler("lscustoms:clientStart", function()
	for k, coords in ipairs(Config.Coords) do
		local callbackId = "VehicleCustoms-"..tostring(k)
		exports.markers:CreateUsable(GetCurrentResourceName(), coords, callbackId, "Enter", Config.Markers.DrawRadius, Config.Markers.Radius, Config.Markers.Blip, {
