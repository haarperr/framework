	...
	Types = {
		["bin_small"] = {
			...
			Loot = {
				...
				-- Drugs.
				{ name = "Weed Seed", chance = 0.185, quantity = { 1, 2 } },
				{ name = "Blue Dream Weed Seed", chance = 0.175, quantity = { 1, 2 } },
		...
		["bin_large"] = {
			...
			Loot = {
				...
				-- Drugs.
				{ name = "Weed Seed", chance = 0.2, quantity = { 1, 3 } },
				{ name = "Blue Dream Weed Seed", chance = 0.225, quantity = { 1, 2 } },
		...
		["mail"] = {
			...
			Loot = {
				...
				{ name = "Ten Dollars", chance = 0.05, quantity = { 1, 1 } },
				{ name = "One Dollar", chance = 0.3, quantity = { 1, 3 } },
			},
		},
	},
	Models = {
