...
AddEventHandler("drugs:attemptSell", function(zone, drug)
	...
	-- Cop price bonus.
	local cops = exports.jobs:CountActiveEmergency("DrugBonus")
...
AddEventHandler("drugs:sell", function()
	...
	if exports.inventory:CountItem(exports.inventory:GetPlayerContainer(source), cache.drug) < cache.amount then
	...
	exports.inventory:GiveItem(source, "Bills", price)
