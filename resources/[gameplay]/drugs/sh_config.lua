Config = {
	...
	Prices = {
		...
		["Weed"] = { Min = 40, Max = 70, Cap = 4, Hotspot = 2.0, MaxCops = 6, CopRate = 0.3 },
		["Cocaine Compact"] = { Min = 100, Max = 140, Cap = 1, Hotspot = 1.5, MaxCops = 6, CopRate = 0.3 },
		["Cocaine Grenada"] = { Min = 80, Max = 120, Cap = 1, Hotspot = 1.5, MaxCops = 6, CopRate = 0.3 },
		["Heroin"] = { Min = 70, Max = 100, Cap = 2, Hotspot = 1.5, MaxCops = 6, CopRate = 0.3 },
		["Laced Heroin"] = { Min = 100, Max = 135, Cap = 3, Hotspot = 1.5, MaxCops = 6, CopRate = 0.3 },
		["Crack Cocaine"] = { Min = 60, Max = 100, Cap = 2, Hotspot = 1.5, MaxCops = 6, CopRate = 0.3 },
	},
	HotSpots = {
