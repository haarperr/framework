...
Restraints.anims = {
	...
	lockpicking = {
		Source = { Dict = "weapons@first_person@aim_idle@p_m_zero@melee@knife@fidgets@a", Name = "fidget_low_loop", Flag = 17, Duration = 9000 },
		Target = { Dict = "mp_arresting", Name = "idle", Flag = 17, Duration = 9000, Force = true, BlendSpeed = 1000.0 },
	},
	cuffed = {
		Dict = "mp_arresting",
		Name = "idle",
