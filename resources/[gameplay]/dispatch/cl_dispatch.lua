...
function Report(group, message, messageType, coords, vehicle, blip)
	local instance = exports.instances:GetPlayerInstance()
...
RegisterCommand("311", function(source, args, command)
	...
	if exports.interaction:IsHandcuffed() or exports.interaction:IsZiptied() or exports.emotes:AreHandsUp() then
...
RegisterCommand("call", function(source, args, command)
	...
	if exports.health:IsPedDead(ped) or exports.interaction:IsHandcuffed() or exports.interaction:IsZiptied() then
		exports.mythic_notify:SendAlert("error", "Can't seem to do that...")
		return
	end
