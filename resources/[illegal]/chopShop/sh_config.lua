Config = {
	...
	Presence = { Min = 3, Max = 8, MaxRate = 1.5 },
	Components = {
		{ Name = "engine", Type = -1, Index = 0, Offset = vector3(0, 0, -0.5), Payout = { Item = "Scrap Metal", Amount = {0, 0} } },
		{ Name = "door_dside_f", Type = 0, Index = 0, Offset = vector3(0.5, 0.5, 0), Payout = { Item = "Scrap Metal", Amount = {0, 0} } },
		{ Name = "door_dside_r", Type = 0, Index = 2, Offset = vector3(0.5, 0.5, 0), Payout = { Item = "Polymer Plastic", Amount = {0, 0} } },
		{ Name = "door_pside_f", Type = 0, Index = 1, Offset = vector3(-0.5, 0.5, 0), Payout = { Item = "Polymer Plastic", Amount = {0, 0} } },
		{ Name = "door_pside_r", Type = 0, Index = 3, Offset = vector3(-0.5, 0.5, 0), Payout = { Item = "Scrap Metal", Amount = {0, 0} } },
		{ Name = "bonnet", Type = 0, Index = 4, Offset = vector3(0, -1.5, 0), Payout = { Item = "Scrap Metal", Amount = {0, 0} } },
		{ Name = "boot", Type = 0, Index = 5, Offset = vector3(0, 1.0, 0), Payout = { Item = "Polymer Plastic", Amount = {0, 0} } },
		{ Name = "wheel_lf", Type = 1, Index = 0, Offset = vector3(0.5, 0, 0), Payout = { Item = "Scrap Rubber", Amount = {0, 0} } },
		{ Name = "wheel_lr", Type = 1, Index = 4, Offset = vector3(0.5, 0, 0), Payout = { Item = "Scrap Rubber", Amount = {0, 0} } },
		{ Name = "wheel_rf", Type = 1, Index = 1, Offset = vector3(-0.5, 0, 0), Payout = { Item = "Scrap Rubber", Amount = {0, 0} } },
		{ Name = "wheel_rr", Type = 1, Index = 5, Offset = vector3(-0.5, 0, 0), Payout = { Item = "Scrap Rubber", Amount = {0, 0} } },
