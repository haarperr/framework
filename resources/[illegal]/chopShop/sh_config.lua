Config = {
	...
	Cars = {
		{ Model = "adder", BasePrice = 800, Chance = 10 },
		{ Model = "akuma", BasePrice = 280, Chance = 80 },
		{ Model = "alpha", BasePrice = 335, Chance = 30 },
		{ Model = "asea", BasePrice = 280, Chance = 50 },
		{ Model = "bagger", BasePrice = 280, Chance = 90 },
		{ Model = "banshee", BasePrice = 335, Chance = 10 },
		{ Model = "banshee2", BasePrice = 335, Chance = 10 },
		{ Model = "bati", BasePrice = 280, Chance = 30 },
		{ Model = "bifta", BasePrice = 280, Chance = 50 },
		{ Model = "bjxl", BasePrice = 280, Chance = 50 },
		{ Model = "buffalo", BasePrice = 335, Chance = 90 },
		{ Model = "bullet", BasePrice = 392, Chance = 10 },
		{ Model = "caddy", BasePrice = 280, Chance = 20 },
		{ Model = "caddy2", BasePrice = 280, Chance = 20 },
		{ Model = "coquette", BasePrice = 392, Chance = 20 },
		{ Model = "dilettante", BasePrice = 280, Chance = 50 },
		{ Model = "dubsta", BasePrice = 225, Chance = 40 },
		{ Model = "dubsta2", BasePrice = 225, Chance = 40 },
		{ Model = "enduro", BasePrice = 280, Chance = 40 },
		{ Model = "esskey", BasePrice = 280, Chance = 45 },
		{ Model = "f620", BasePrice = 280, Chance = 40 },
		{ Model = "faction", BasePrice = 280, Chance = 50 },
		{ Model = "felon", BasePrice = 280, Chance = 30 },
		{ Model = "feltzer2", BasePrice = 225, Chance = 85 },
		{ Model = "fusilade", BasePrice = 225, Chance = 20 },
		{ Model = "glendale", BasePrice = 280, Chance = 50 },
		{ Model = "granger", BasePrice = 280, Chance = 50 },
		{ Model = "habanero", BasePrice = 280, Chance = 50 },
		{ Model = "issi2", BasePrice = 280, Chance = 50 },
		{ Model = "jester", BasePrice = 225, Chance = 40 },
		{ Model = "jester2", BasePrice = 300, Chance = 40 },
		{ Model = "kalahari", BasePrice = 280, Chance = 50 },
		{ Model = "massacro", BasePrice = 225, Chance = 30 },
		{ Model = "mesa", BasePrice = 280, Chance = 45 },
		{ Model = "mesa3", BasePrice = 280, Chance = 50 },
		{ Model = "mower", BasePrice = 280, Chance = 20 },
		{ Model = "ninef", BasePrice = 225, Chance = 20 },
		{ Model = "ninef2", BasePrice = 262, Chance = 25 },
		{ Model = "oracle", BasePrice = 280, Chance = 50 },
		{ Model = "panto", BasePrice = 150, Chance = 50 },
		{ Model = "patriot", BasePrice = 280, Chance = 60 },
		{ Model = "phoenix", BasePrice = 280, Chance = 50 },
		{ Model = "premier", BasePrice = 150, Chance = 50 },
		{ Model = "rebel", BasePrice = 150, Chance = 40 },
		{ Model = "rebel2", BasePrice = 150, Chance = 50 },
		{ Model = "regina", BasePrice = 280, Chance = 50 },
		{ Model = "rentalbus", BasePrice = 280, Chance = 70 },
		{ Model = "rhapsody", BasePrice = 150, Chance = 50 },
		{ Model = "rocoto", BasePrice = 150, Chance = 50 },
		{ Model = "sabregt", BasePrice = 225, Chance = 60 },
		{ Model = "sandking", BasePrice = 280, Chance = 50 },
		{ Model = "sandking2", BasePrice = 150, Chance = 40 },
		{ Model = "schafter2", BasePrice = 225, Chance = 50 },
		{ Model = "schafter3", BasePrice = 280, Chance = 20 },
		{ Model = "schafter4", BasePrice = 180, Chance = 30 },
		{ Model = "seminole", BasePrice = 280, Chance = 35 },
		{ Model = "sentinel", BasePrice = 335, Chance = 50 },
		{ Model = "sentinel2", BasePrice = 335, Chance = 100 },
		{ Model = "sovereign", BasePrice = 150, Chance = 80 },
		{ Model = "speedo", BasePrice = 150, Chance = 70 },
		{ Model = "stretch", BasePrice = 335, Chance = 20 },
		...
		{ Model = "voltic", BasePrice = 360, Chance = 10 },
