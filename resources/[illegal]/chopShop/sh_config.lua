Config = {
	...
	Cars = {
		{ Model = "adder", BasePrice = 400, Chance = 10 },
		{ Model = "akuma", BasePrice = 80, Chance = 80 },
		{ Model = "alpha", BasePrice = 135, Chance = 30 },
		{ Model = "asea", BasePrice = 180, Chance = 50 },
		{ Model = "bagger", BasePrice = 80, Chance = 90 },
		{ Model = "banshee", BasePrice = 135, Chance = 10 },
		{ Model = "banshee2", BasePrice = 135, Chance = 10 },
		{ Model = "bati", BasePrice = 180, Chance = 30 },
		{ Model = "bifta", BasePrice = 80, Chance = 50 },
		{ Model = "bjxl", BasePrice = 80, Chance = 50 },
		{ Model = "buffalo", BasePrice = 135, Chance = 90 },
		{ Model = "bullet", BasePrice = 192, Chance = 10 },
		{ Model = "caddy", BasePrice = 180, Chance = 20 },
		{ Model = "caddy2", BasePrice = 180, Chance = 20 },
		{ Model = "coquette", BasePrice = 192, Chance = 20 },
		{ Model = "dilettante", BasePrice = 180, Chance = 50 },
		{ Model = "dubsta", BasePrice = 125, Chance = 40 },
		{ Model = "dubsta2", BasePrice = 125, Chance = 40 },
		{ Model = "enduro", BasePrice = 180, Chance = 40 },
		{ Model = "esskey", BasePrice = 180, Chance = 45 },
		{ Model = "f620", BasePrice = 180, Chance = 40 },
		{ Model = "faction", BasePrice = 180, Chance = 50 },
		{ Model = "felon", BasePrice = 180, Chance = 30 },
		{ Model = "feltzer2", BasePrice = 125, Chance = 85 },
		{ Model = "fusilade", BasePrice = 125, Chance = 20 },
		{ Model = "glendale", BasePrice = 180, Chance = 50 },
		{ Model = "granger", BasePrice = 140, Chance = 50 },
		{ Model = "habanero", BasePrice = 140, Chance = 50 },
		{ Model = "issi2", BasePrice = 140, Chance = 50 },
		{ Model = "jester", BasePrice = 125, Chance = 40 },
		{ Model = "jester2", BasePrice = 160, Chance = 40 },
		{ Model = "kalahari", BasePrice = 80, Chance = 50 },
		{ Model = "massacro", BasePrice = 125, Chance = 30 },
		{ Model = "mesa", BasePrice = 80, Chance = 45 },
		{ Model = "mesa3", BasePrice = 80, Chance = 50 },
		{ Model = "mower", BasePrice = 80, Chance = 20 },
		{ Model = "ninef", BasePrice = 125, Chance = 20 },
		{ Model = "ninef2", BasePrice = 162, Chance = 25 },
		{ Model = "oracle", BasePrice = 80, Chance = 50 },
		{ Model = "panto", BasePrice = 50, Chance = 50 },
		{ Model = "patriot", BasePrice = 180, Chance = 60 },
		{ Model = "phoenix", BasePrice = 180, Chance = 50 },
		{ Model = "premier", BasePrice = 50, Chance = 50 },
		{ Model = "rebel", BasePrice = 50, Chance = 40 },
		{ Model = "rebel2", BasePrice = 50, Chance = 50 },
		{ Model = "regina", BasePrice = 180, Chance = 50 },
		{ Model = "rentalbus", BasePrice = 80, Chance = 70 },
		{ Model = "rhapsody", BasePrice = 50, Chance = 50 },
		{ Model = "rocoto", BasePrice = 50, Chance = 50 },
		{ Model = "sabregt", BasePrice = 125, Chance = 60 },
		{ Model = "sandking", BasePrice = 80, Chance = 50 },
		{ Model = "sandking2", BasePrice = 150, Chance = 40 },
		{ Model = "schafter2", BasePrice = 125, Chance = 50 },
		{ Model = "schafter3", BasePrice = 180, Chance = 20 },
		{ Model = "schafter4", BasePrice = 80, Chance = 30 },
		{ Model = "seminole", BasePrice = 180, Chance = 35 },
		{ Model = "sentinel", BasePrice = 135, Chance = 50 },
		{ Model = "sentinel2", BasePrice = 235, Chance = 100 },
		{ Model = "sovereign", BasePrice = 50, Chance = 80 },
		{ Model = "speedo", BasePrice = 50, Chance = 70 },
		{ Model = "stretch", BasePrice = 135, Chance = 20 },
		{ Model = "sultan", BasePrice = 185, Chance = 80 },
		{ Model = "superd", BasePrice = 175, Chance = 50 },
		{ Model = "taco", BasePrice = 50, Chance = 70 },
		{ Model = "tourbus", BasePrice = 50, Chance = 70 },
		{ Model = "turismor", BasePrice = 360, Chance = 10 },
		...
		{ Model = "zentorno", BasePrice = 200, Chance = 10 },
	},
