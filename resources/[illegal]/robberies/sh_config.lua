Config = {
	...
	Robbables = {
		["register"] = {
			...
			Output = {
				{ Name = "Bills", Amount = {150, 250}, Chance = 1.0 },
		...
		["safe"] = {
			...
			Output = {
				{ Name = "Bills", Amount = {1000, 3000}, Chance = 1.0 },
				{ Name = "Red Keycard", Amount = 1, Chance = 0.2 },
				{ Name = "Lockpick", Amount = {1,2}, Chance = 0.20 },
				{ Name = "Joint", Amount = {1,4}, Chance = 0.60 },
				{ Name = "Weed", Amount = {2,8}, Chance = 0.40 },
				{ Name = "Diamond", Amount = 2, Chance = 0.50 },
			},
		},
		["safe2"] = {
			Stages = {
		...
		["lockbox"] = {
			...
			Output = {
				{ Name = "Valuable Goods", Amount = {1, 2}, Chance = 1.0 },
				{ Name = "Bills", Amount = {500, 1000}, Chance = 0.1 },
				{ Name = "Blue Keycard", Amount = 1, Chance = 0.06 },
				{ Name = "Brown Keycard", Amount = 1, Chance = 0.02 },
				{ Name = "Green Keycard", Amount = 1, Chance = 0.04 },
				{ Name = "Red Keycard", Amount = 1, Chance = 0.04 },
				{ Name = "Black Keycard", Amount = 1, Chance = 0.01 },
			},
		},
		["drillbox"] = {
			Stages = {
		...
		["crate"] = {
			...
			Output = {
				...
				{ Name = "Bills", Amount = {1500, 3000}, Chance = 0.1 },
			},
		},
		["cabinet"] = {
			Stages = {
		...
		["jewelry"] = {
			...
			Output = {
				{ Name = "Diamond", Amount = {3,6}, Chance = 1.0 },
				{ Name = "Ruby", Amount = {3,6}, Chance = 1.0 },
				{ Name = "Saphire", Amount = {3,6}, Chance = 1.0 },
				{ Name = "Emerald", Amount = {3,6}, Chance = 1.0 },
			},
		},
		["key"] = {
			Stages = {
		...
		Sites = {
			...
			},
			{
				...
				Robbables = {
					{ Id = "register" },
					{ Id = "safe2", Coords = {
						vector4(168.9355621337891, 6644.79833984375, 31.71062850952148, 315.8774719238281),
					}},
				},
			},
			{
			...
			},
			{
				Name = "Zancudo",
				Type = "Convenience Store",
				Center = vector3(-2544.115966796875, 2311.63720703125, 33.41083145141601),
				Robbables = {
					{ Id = "register" },
					{ Id = "safe2", Coords = {
						vector4(-2542.444580078125, 2305.46875, 33.41079711914062, 182.42337036132812),
					}},
				},
			},
			--[[ Liquor Store ]]--
			...
			},
			{
				Name = "Grapeseed",
				Type = "Liquor Store",
				Center = vector3(1683.605712890625, 4864.2392578125, 41.07291412353515),
				Robbables = {
					{ Id = "register" },
					{ Id = "safe", Coords = {
						vector4(1694.189697265625, 4863.3095703125, 41.07289886474609, 188.4333953857422),
					}}
				},
			},
			{
				...
				Robbables = {
					{
						...
						Unlocks = {
							vector3(-352.73651123047, -53.572479248047, 49.175434112549),
						},
						Items = { "Green Keycard" },
					},
					{
			...
			{
				Name = "Grapeseed Main Fleeca",
				Type = "Bank",
				Center = vector3(1652.595458984375, 4850.2412109375, 42.47996520996094),
				Radius = 30.0,
				RegisterDoors = true,
				Robbables = {
					{
						Id = "keypad",
						Coords = {
							vector4(1647.0015869140625, 4850.65478515625, 42.00904846191406, 179.22593688964844),
						},
						Unlocks = {
							vector3(1649.16064453125, 4850.80908203125, 42.00902557373047),
						},
						Items = { "Green Keycard" },
					},
					{
						Id = "lockbox",
						Coords = {
							vector4(1649.3780517578125, 4848.66162109375, 41.98727798461914, 276.8650512695313),
							vector4(1648.524169921875, 4846.8203125, 41.98728942871094, 187.1644287109375),
							vector4(1645.645751953125, 4849.7841796875, 41.98727416992187, 6.64275646209716),
							vector4(1644.1378173828125, 4849.47607421875, 42.00025177001953, 3.81802439689636),
							vector4(1643.6058349609375, 4848.1669921875, 42.00715255737305, 98.1469955444336),
							vector4(1643.737548828125, 4846.65869140625, 42.00849914550781, 95.43348693847656),
							vector4(1644.697021484375, 4845.73828125, 42.00735473632812, 185.92276000976565),
							vector4(1646.130615234375, 4845.87060546875, 41.99914169311523, 188.0811462402344),
						},
					},
				},
			},
			{
				...
				Robbables = {
					...
					},
					{
						...
						Output = {
							{ Name = "Bills", Amount = {4969, 9420}, Chance = 0.6 },
							{ Name = "Plastic Explosive", Amount = {4, 8}, Chance = 0.6 },
			...
			-- 				vector4(-623.0833740234375, -232.94891357421875, 38.05704498291016, 303.95703125),
...
for k, site in ipairs(Config.Robberies.Sites) do
	if site.RegisterDoors then
		...
		exports.doors:RegisterGroup({
			...
			overrides = overrides,
			locked = true,
			factions = { "lssd", "lspd", "dps", "paramedic" },
		})
	end
end