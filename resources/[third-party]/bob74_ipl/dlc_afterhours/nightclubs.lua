...
AfterHoursNightclubs = {
    ...
    LoadDefault = function()
        ...
        AfterHoursNightclubs.Interior.Name.Clear()
        ...
        AfterHoursNightclubs.Interior.Trophy.Enable(AfterHoursNightclubs.Interior.Trophy.number1, false)
        AfterHoursNightclubs.Interior.Trophy.Enable(AfterHoursNightclubs.Interior.Trophy.battler, false)
        AfterHoursNightclubs.Interior.Trophy.Enable(AfterHoursNightclubs.Interior.Trophy.dancer, false)

        AfterHoursNightclubs.Interior.DryIce.Enable(false)

        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_Clutter", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_Worklamps", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_deliverytruck", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_dry_ice", false)
        AfterHoursNightclubs.Interior.Details.Enable("light_rigs_off", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_lightgrid_01", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trad_lights", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy04", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy05", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy07", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy08", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy09", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy10", false)
        AfterHoursNightclubs.Interior.Details.Enable("Int01_ba_trophy11", false)
