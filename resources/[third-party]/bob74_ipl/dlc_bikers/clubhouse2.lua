...
BikerClubhouse2 = {
    ...
    LoadDefault = function()
        ...
        BikerClubhouse2.Walls.Set(BikerClubhouse2.Walls.plain, BikerClubhouse2.Walls.Color.red)
        ...
        BikerClubhouse2.Decoration.Clear()
        BikerClubhouse2.Mural.Set(BikerClubhouse2.Mural.none)
