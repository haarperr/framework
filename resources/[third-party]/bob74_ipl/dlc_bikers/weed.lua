...
BikerWeedFarm = {
    ...
    LoadDefault = function()
        ...
        BikerWeedFarm.Plant1.Clear(BikerWeedFarm.Plant1.Stage.medium, BikerWeedFarm.Plant1.Light.basic)
        BikerWeedFarm.Plant2.Clear(BikerWeedFarm.Plant2.Stage.full, BikerWeedFarm.Plant2.Light.basic)
        BikerWeedFarm.Plant3.Clear(BikerWeedFarm.Plant3.Stage.medium, BikerWeedFarm.Plant3.Light.basic)
        BikerWeedFarm.Plant4.Clear(BikerWeedFarm.Plant4.Stage.full, BikerWeedFarm.Plant4.Light.basic)
        BikerWeedFarm.Plant5.Clear(BikerWeedFarm.Plant5.Stage.medium, BikerWeedFarm.Plant5.Light.basic)
        BikerWeedFarm.Plant6.Clear(BikerWeedFarm.Plant6.Stage.full, BikerWeedFarm.Plant6.Light.basic)
        BikerWeedFarm.Plant7.Clear(BikerWeedFarm.Plant7.Stage.medium, BikerWeedFarm.Plant7.Light.basic)
        BikerWeedFarm.Plant8.Clear(BikerWeedFarm.Plant8.Stage.full, BikerWeedFarm.Plant8.Light.basic)
        BikerWeedFarm.Plant9.Clear(BikerWeedFarm.Plant9.Stage.full, BikerWeedFarm.Plant9.Light.basic)
