if Config.EnableGuidebookIntegration then
    ...
    pokerContent = pokerContent:gsub( "ANTENAME", Translation.POKER_ANTE_BET)
    pokerContent = pokerContent:gsub( "PPNAME", Translation.POKER_PAIR_PLUS_BET)
    ...
    rouletteContent = rouletteContent:gsub( "INSIDE", Translation.ROULETTE_RULES_INSIDE_BETS)
    rouletteContent = rouletteContent:gsub( "OUTSIDE", Translation.ROULETTE_RULES_OUTSIDE_BETS)
    ...
    blackjackContent = blackjackContent:gsub( "BETDATA", Translation.ROULETTE_RULES_BET_LIMITS)
