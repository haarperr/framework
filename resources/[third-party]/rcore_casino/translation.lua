Translation = {
    ...
    BLACKJACK_RULES_PART3 = "Double Down\n\nAfter a player has been dealt their two initial cards, they can double their bet in return for one additional card. This is also available on both hands after splitting.\n",
    ...
    CASHIER_PRESS_TO_USE = "Press ~INPUT_TALK~ to talk with the cashier.",
    ...
    CASHIER_VIP_CONFIRM_MSG = "Are you sure you want to purchase VIP for %s? It vill be valid for %s.",
