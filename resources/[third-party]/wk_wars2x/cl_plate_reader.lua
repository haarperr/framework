...
-- This function is pretty much straight from WraithRS, it does the job so I didn't see the point in not using it. Hides the radar UI when certain criteria is met, e.g. in pause menu or stepped out of the patrol vehicle.
